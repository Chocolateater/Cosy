...
<head>
    <title>Code coverage report for algolia.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> algolia.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import striptags from 'striptags'
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (attributeForDistinct) {
<span class="cstat-no" title="statement not covered" >    await algoliaIndex.setSettings({</span>
