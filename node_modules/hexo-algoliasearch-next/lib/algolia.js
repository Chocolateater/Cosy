...
const preparePosts = (posts, fields, fieldsWithFilters) => {
  ...
  return processedPosts.reduce((prev, curr) => {
    var _ref, _ref2, _curr$content;
    const content = (_ref = (_ref2 = (_curr$content = curr === null || curr === void 0 ? void 0 : curr.content) !== null && _curr$content !== void 0 ? _curr$content : curr === null || curr === void 0 ? void 0 : curr.contentStrip) !== null && _ref2 !== void 0 ? _ref2 : curr === null || curr === void 0 ? void 0 : curr.contentStripTruncate) !== null && _ref !== void 0 ? _ref : '';
...
const algoliaCommand = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(function* (hexo, args, callback) {
    ...
    if (attributeForDistinct) {
      yield algoliaIndex.setSettings({
